...
st.set_page_config(page_title='NSCLC Survival Prediction', layout='wide', initial_sidebar_state='expanded')
...
if predict_button:
    if model_choice == 'Cox Proportional Hazards':
        ...
        st.subheader(f'Predicted Mean Survival Time: {predicted_means_sta[0]:.2f} months')
